...
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/its-qcmn-noisypix.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/its-qcmn-noisypix'
QC_CONFIG_PARAM='qc_config_uri'

cd ..

WF_NAME=its-qcmn-noisypix-remote
