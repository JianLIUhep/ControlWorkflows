...
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/its-qcmn-fhr-fee-no-ds-entire-postp.json'
...
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/its-qcmn-fhr-fee-no-ds-entire-postp'
WF_NAME=its-qcmn-fhr-fee-no-ds-entire-postp-remote
